...
# path="/Users/Lab/Documents/CommunityDetection/"
# GraphElements = importGraphElements('com-lj.ungraph.txt','com-lj.all.cmty.txt',path)
# Fscore = Performance(GraphElements,"InfoIG",100,500000,path,path+'snap/',"SimiNbCom",14400)
